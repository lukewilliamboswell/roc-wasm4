...
initTitleScreen = \frameCount, plants ->
    rocciSpriteSheet = createRocciSpriteSheet {}
    TitleScreen {
        frameCount,
        plants,
        rocciSpriteSheet,
        rocciIdleAnim: createRocciIdleAnim rocciSpriteSheet frameCount,
...
initGame =
    \{ frameCount, rocciSpriteSheet, groundSprite, plants, plantSpriteSheet } ->
        Game {
            frameCount,
            score: 0,
            player: {
            ...
            lastFlap: Bool.true,
            rocciSpriteSheet,
            rocciFlapAnim: createRocciFlapAnim rocciSpriteSheet frameCount,
...
initGameOver = \{ frameCount, rocciSpriteSheet, score, pipeSprite, groundSprite, player, pipes, plants, plantSpriteSheet, groundX } ->
    GameOver {
        ...
        plants,
        rocciSpriteSheet,
        rocciFallAnim: createRocciFallAnim rocciSpriteSheet frameCount,
        pipeSprite,
        groundSprite,
        plantSpriteSheet,
        groundX,
...
createRocciIdleAnim : Sprite, U64 -> Animation
createRocciIdleAnim = \rocciSpriteSheet, frameCount -> {
...
createRocciFlapAnim : Sprite, U64 -> Animation
createRocciFlapAnim = \rocciSpriteSheet, frameCount -> {
    lastUpdated: frameCount,
    index: 2,
    state: Completed,
    cells: [
...
createRocciFallAnim : Sprite, U64 -> Animation
createRocciFallAnim = \rocciSpriteSheet, frameCount -> {
    lastUpdated: frameCount,
    index: 0,
    state: Loop,
    cells: [
...
createRocciSpriteSheet : {} -> Sprite
createRocciSpriteSheet = \{} ->
    Sprite.new {
